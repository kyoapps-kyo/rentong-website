<div class=" container mx-auto lg:px-40 lg:pb-20 md:pb-20">
  <div class="flex">
    ...
    <div class="border-gray-100 border-2 shadow-xl lg:p-10 lg:ml-14 lg:text-xl md:text-2xl md:px-10 md:py-10">
      ...
      <p class="leading-relaxed textIndent pt-6">今年的后半阶段，由于明年民宿法律改正的波动，不动产行业也受到了很大影响，伴随日元升值的影响越来越大,京都不动产投资市场机会与风险并存的局面也会越来越多吧。但是，在这其中，我认为，构建促进行业前进的体制是必要的，我们也一直着眼于构建作为得到更多投资商支持和信赖的综合性不动产不断成长的坚固基础和体制O所以我认为，即使为了多增加一件签约物件也应该积极地整理体制，即使为了增加0.1%的收益率也应该强化营业水平。在营业中，以前所未有的努力积极主动地寻找物件，为创造敝公司信息发布机会和提供范围更广的服务倾尽全力。而且，录用新入员工，用人力资源提供更加丰富的服务。今年的后半阶段也会秉持”不忘初心“的精神，严格甄选投资范围，在与各位继续维持和睦关系的同时，将会更加用心地为各位提供与各种各样的生活方式、投资方式相契合的物件和更优质的服务，各位敬请期待!
      </p>
      <p class=" text-right leading-relaxed pt-6">株式会社仁通</p>
      <p class=" text-right leading-relaxed pt-6">代表取缔役 刘丞</p>
    </div>
  </div>
</div>
